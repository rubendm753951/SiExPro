<%@ Page AutoEventWireup="false"  Inherits="Reports_Reporte_contenedores" Language="VB" CodeFile="Reporte_contenedores.aspx.vb" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 74%;">
        ...
        <LocalReport EnableHyperlinks="True" ReportPath="Reports\Reporte_Contenedores.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                    Name="DataSet_sp_select_reporte_contenedores" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        TypeName="Reporte_ContenedoresTableAdapters.sp_select_reporte_contenedoresTableAdapter">
        <SelectParameters>
