<%@ Page Language="VB" AutoEventWireup="false" CodeFile="guia_iata.aspx.vb" Inherits="ops_pages_guia_iata" %>
...
<body>
    ...
    <div style="text-align: center">
            ...
            SelectCommand="sp_Select_Datos_Envio_iata" SelectCommandType="StoredProcedure">
            <SelectParameters>
