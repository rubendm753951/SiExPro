<%@ Page Language="VB" AutoEventWireup="false" CodeFile="guia_individual.aspx.vb" Inherits="ops_pages_guia_individual" %>
...
<body>
    ...
    <div style="text-align: center">
            ...
            SelectCommand="sp_Select_Datos_Envio_Individual" SelectCommandType="StoredProcedure">
            <SelectParameters>
