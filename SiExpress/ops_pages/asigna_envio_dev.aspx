<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="asigna_envio_dev.aspx.vb" Inherits="ops_pages_asigna_envio_dev" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="position: absolute; top: 141px; left: 253px; width: 668px; height: 460px;">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td style="height: 43px;" colspan="2">
                                            <strong style="font-size: medium">Asignación de Envíos para Devolución</strong><br />
                                        </td>
                                        <td style="height: 43px" colspan="2">
                                            <strong style="font-size: medium">&nbsp;Causa de devolución</strong><br />
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <asp:TextBox CssClass="form-control" Height="27px" ID="TxtObs" runat="server"
                    Width="250px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:Button CssClass="btn btn-outline btn-success btn-sm" ID="Asignar" runat="server" Text="Asignar y devolver" TabIndex="2"
                                                Width="130px" />
                                            <asp:Button CssClass="btn btn-outline btn-success btn-sm" ID="Button3" runat="server" Text="Manifiesto"
                                                Width="115px" />
                                        </td>
                                    </tr>
                                    <tr>
